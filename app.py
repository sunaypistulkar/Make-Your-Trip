...
rfc=RandomForestClassifier(n_estimators=100,criterion='gini', max_depth=11 ,random_state=7)
...
st.write('')
st.markdown("_This application is using data & machine learning algorithm, it has achived 98.4% of accuracy! However, you might observe wrong result which belong to 1.6% of inaccuracy._")
